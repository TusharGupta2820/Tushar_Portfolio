        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {RESEARCH_TOPICS.map((topic) => (
            <div
              ...
              data-cursor="explore"
              className="p-6 sm:p-8 rounded-2xl bg-[#090a10]/90 border border-white/10 hover:border-violet-500/40 transition-all duration-300 flex flex-col justify-between group cursor-pointer shadow-lg hover:shadow-violet-500/10 hover:-translate-y-1"
            >
